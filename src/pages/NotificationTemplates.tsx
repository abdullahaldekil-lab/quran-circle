              ...
              <TableRow key={t.id}>
                ...
                <TableCell>
                  <div className="flex gap-1">
                    <Button aria-label="تعديل" variant="ghost" size="icon" onClick={() => openEdit(t)}><Pencil className="w-4 h-4" /></Button>
                    <Button aria-label="حذف" variant="ghost" size="icon" onClick={() => handleDelete(t.id)}><Trash2 className="w-4 h-4 text-destructive" /></Button>
                  </div>
                </TableCell>
              </TableRow>
            ))}
