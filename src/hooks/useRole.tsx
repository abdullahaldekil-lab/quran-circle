...
const rolePermissions: Record<StaffRole, string[]> = {
  manager: [
    ...
    "/staff-attendance", "/staff-attendance-log", "/staff-shifts", "/staff-qr-management", "/staff-qr-checkin", "/staff-tasks", "/staff-tasks-analytics",
    ...
    "/permissions-management", "/internal-requests", "/work-hub", "/data-archive",
  ...
  supervisor: [
    ...
    "/narration-test", "/review-test", "/narration-stats",
    "/staff-attendance", "/staff-attendance-log", "/staff-shifts", "/staff-qr-checkin", "/staff-tasks", "/staff-tasks-analytics",
    "/student-attendance-report", "/student-annual-plan",
    "/notification-preferences", "/internal-requests", "/work-hub", "/data-archive",
    "/programs-overview", "/halaqa-performance", "/enrollment-form",
  ...
  teacher: [
    ...
    "/quran-narration", "/excellence", "/excellence-comparison", "/student-quiz", "/quiz-results", "/quiz-comparison",
    "/narration-test", "/review-test", "/narration-stats",
    "/staff-attendance-log", "/staff-qr-checkin",
    "/student-attendance-report", "/student-annual-plan",
    "/notification-preferences", "/internal-requests", "/work-hub", "/staff-tasks", "/staff-tasks-analytics",
  ...
  assistant_teacher: [
    ...
    "/staff-attendance-log", "/staff-qr-checkin",
    "/notification-preferences", "/internal-requests", "/work-hub", "/staff-tasks", "/staff-tasks-analytics",
    "/tarbawi-follow-up", "/tarbawi-leaderboard", "/tarbawi-calendar",
  ],
};
...
const talqeenSupervisorRoutes = [
  ...
  "/staff-attendance-log", "/staff-qr-checkin", "/staff-tasks", "/staff-tasks-analytics",
  "/notification-preferences", "/internal-requests", "/work-hub",
  "/programs-overview", "/halaqa-performance",
