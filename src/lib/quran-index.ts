// Auto-generated Quran index data (Hafs / Madinah mushaf, 604 pages).
// Source: alquran.cloud meta + quran.com chapters. Do not edit by hand.

/** Arabic surah names, index 0 = سورة 1. */
export const SURAH_NAMES: string[] = [
  ...
  "المزمل", "المدثر", "القيامة", "الانسان", "المرسلات", "النبإ",
...
export const SURAH_AYAHS: number[] = [
...
/** First ayah on each mushaf page as [surah, ayah], index 0 = page 1. */
export const PAGE_STARTS: [number, number][] = [
...
/** First ayah of each of the 240 hizb quarters as [surah, ayah]. */
export const HIZB_QUARTER_STARTS: [number, number][] = [
